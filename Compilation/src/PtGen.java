		...
		switch (numGen) {
			...
			case 31: 
				if(tabSymb[idVarAffectation].type != tCour) {
					UtilLex.messErr("type incompatible avec le type de la variable Ã  affecter");
				}
			...
			case 51: 
				...
				if(tabSymb[idIdent].categorie == CONSTANTE) {
					UtilLex.messErr("Vous ne pouvez pas dÃ©clarer de constante en parametre modifiable de fonction");
				}
				nbParamAppel++;
			...
			case 56 : 
				...
				break;
			case 57 : 
				placeIdent(-1, PARAMFIXE, tCour, iterateurDesVariables);// Ã  modifier l'info, mettre le compteur
				iterateurDesVariables++;
				break;
			case 58 : 
