...
public class projetParser extends Parser {
	...
	public final void inscond() throws RecognitionException {
		try {
			...
			match(input,39,FOLLOW_39_in_inscond828); 
			PtGen.pt(42);
			}
	...
	public final void boucle() throws RecognitionException {
		try {
			...
			{
			match(input,53,FOLLOW_53_in_boucle844); 
			PtGen.pt(36);
			pushFollow(FOLLOW_expression_in_boucle848);
			expression();
			state._fsp--;

			match(input,36,FOLLOW_36_in_boucle850); 
			PtGen.pt(37);
			pushFollow(FOLLOW_instructions_in_boucle854);
			instructions();
			state._fsp--;

			match(input,37,FOLLOW_37_in_boucle856); 
			PtGen.pt(38);
			}
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_lecture870); 
			match(input,10,FOLLOW_10_in_lecture872); 
			pushFollow(FOLLOW_ident_in_lecture874);
			ident();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_lecture880); 
					pushFollow(FOLLOW_ident_in_lecture882);
					ident();
					state._fsp--;
			...
			match(input,11,FOLLOW_11_in_lecture889); 
			}
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,33,FOLLOW_33_in_ecriture902); 
			match(input,10,FOLLOW_10_in_ecriture904); 
			pushFollow(FOLLOW_expression_in_ecriture906);
			expression();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_ecriture912); 
					pushFollow(FOLLOW_expression_in_ecriture914);
					expression();
					state._fsp--;
		...
		try {
			...
			switch (alt38) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_expression_in_effixes1006);
					expression();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effixes1011); 
							pushFollow(FOLLOW_expression_in_effixes1013);
							expression();
							state._fsp--;
			...
			match(input,11,FOLLOW_11_in_effixes1022); 
			}
	...
	public final void effmods() throws RecognitionException {
		try {
			...
			{
			match(input,10,FOLLOW_10_in_effmods1034); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effmods1042); 
							pushFollow(FOLLOW_ident_in_effmods1044);
							ident();
							state._fsp--;
			...
			match(input,11,FOLLOW_11_in_effmods1053); 
			}
	...
	public final void expression() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp1_in_expression1067);
			exp1();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,47,FOLLOW_47_in_expression1071); 
					PtGen.pt(23);
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,35,FOLLOW_35_in_exp11099); 
					PtGen.pt(23);
		...
		try {
			...
			switch (alt43) {
				case 1 :
					...
					{
					match(input,46,FOLLOW_46_in_exp21124); 
					pushFollow(FOLLOW_exp2_in_exp21126);
					exp2();
					state._fsp--;
				...
				case 2 :
					// projet.g:154:5: exp3
					{
					pushFollow(FOLLOW_exp3_in_exp21137);
					exp3();
					state._fsp--;
		...
		try {
			...
			switch (alt44) {
				case 1 :
					// projet.g:158:5: '=' exp4
					{
					match(input,22,FOLLOW_22_in_exp31160); 
					PtGen.pt(12);
				...
				case 2 :
					// projet.g:159:5: '<>' exp4
					{
					match(input,21,FOLLOW_21_in_exp31175); 
					PtGen.pt(12);
				...
				case 3 :
					// projet.g:160:5: '>' exp4
					{
					match(input,23,FOLLOW_23_in_exp31189); 
					PtGen.pt(12);
				...
				case 4 :
					// projet.g:161:5: '>=' exp4
					{
					match(input,24,FOLLOW_24_in_exp31204); 
					PtGen.pt(12);
				...
				case 5 :
					// projet.g:162:5: '<' exp4
					{
					match(input,19,FOLLOW_19_in_exp31218); 
					PtGen.pt(12);
				...
				case 6 :
					// projet.g:163:5: '<=' exp4
					{
					match(input,20,FOLLOW_20_in_exp31233); 
					PtGen.pt(12);
					pushFollow(FOLLOW_exp4_in_exp31237);
					exp4();
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 2 :
					...
					{
					match(input,15,FOLLOW_15_in_exp41292); 
					PtGen.pt(12);
		...
		try {
			...
			while (true) {
				...
				case 2 :
					...
					{
					match(input,32,FOLLOW_32_in_exp51367); 
					PtGen.pt(12);
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1400);
					valeur();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_ident_in_primaire1408);
					ident();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,10,FOLLOW_10_in_primaire1417); 
					pushFollow(FOLLOW_expression_in_primaire1419);
					expression();
					state._fsp--;

					match(input,11,FOLLOW_11_in_primaire1421); 
					}
					break;
		...
		try {
			...
			switch (alt48) {
				...
				case 2 :
					...
					{
					match(input,13,FOLLOW_13_in_valeur1443); 
					pushFollow(FOLLOW_nbentier_in_valeur1445);
					nbentier();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,15,FOLLOW_15_in_valeur1453); 
					pushFollow(FOLLOW_nbentier_in_valeur1455);
					nbentier();
					state._fsp--;
				...
				case 4 :
					// projet.g:187:5: 'vrai'
					{
					match(input,55,FOLLOW_55_in_valeur1463); 
					PtGen.pt(8);
					}
					break;
				case 5 :
					// projet.g:188:5: 'faux'
					{
					match(input,38,FOLLOW_38_in_valeur1471); 
					PtGen.pt(9);
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			// projet.g:198:15: INT
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier1501); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			// projet.g:200:9: ID
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident1512); 
	...
	public static final BitSet FOLLOW_39_in_inscond828 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_53_in_boucle844 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_boucle848 = new BitSet(new long[]{0x0000001000000000L});
	public static final BitSet FOLLOW_36_in_boucle850 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_boucle854 = new BitSet(new long[]{0x0000002000000000L});
	public static final BitSet FOLLOW_37_in_boucle856 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_43_in_lecture870 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_lecture872 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture874 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_lecture880 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture882 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_lecture889 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_33_in_ecriture902 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_ecriture904 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture906 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_ecriture912 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture914 = new BitSet(new long[]{0x0000000000004800L});
	...
	public static final BitSet FOLLOW_expression_in_effixes1006 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effixes1011 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_effixes1013 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_effixes1022 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effmods1034 = new BitSet(new long[]{0x0000000000000820L});
	public static final BitSet FOLLOW_ident_in_effmods1037 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effmods1042 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_effmods1044 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_effmods1053 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp1_in_expression1067 = new BitSet(new long[]{0x0000800000000002L});
	public static final BitSet FOLLOW_47_in_expression1071 = new BitSet(new long[]{0x008040400000A460L});
	...
	public static final BitSet FOLLOW_35_in_exp11099 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp11104 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_46_in_exp21124 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp21126 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp3_in_exp21137 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp4_in_exp31153 = new BitSet(new long[]{0x0000000001F80002L});
	public static final BitSet FOLLOW_22_in_exp31160 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31165 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_21_in_exp31175 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31179 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_23_in_exp31189 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31194 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_exp31204 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31208 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_19_in_exp31218 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31223 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_exp31233 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31237 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp5_in_exp41261 = new BitSet(new long[]{0x000000000000A002L});
	...
	public static final BitSet FOLLOW_15_in_exp41292 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_32_in_exp51367 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51372 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_valeur_in_primaire1400 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire1408 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_primaire1417 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_primaire1419 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_primaire1421 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1435 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_valeur1443 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1445 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_valeur1453 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1455 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_55_in_valeur1463 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_38_in_valeur1471 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier1501 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident1512 = new BitSet(new long[]{0x0000000000000002L});
}
